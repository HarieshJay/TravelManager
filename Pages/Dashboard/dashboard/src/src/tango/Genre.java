...
public class Genre {
	...
	private static Map<String, Map<String, Double>> similarityTable;
	private String g;
	...
	// Might want to compare similar genres
	@Override
	...
	public static void main(String args[]) throws IOException {
		readGenreSimilarities("data/genreSimilarity.json");
		
		System.out.println(new Genre("Pop").howSimilar(new Genre("Dance")));
	}
}
